...
// @access    Private
exports.updateDetails = wrap(async (req, res, next) => {
...
// @access    Private
exports.updatePassword = wrap(async (req, res, next) => {
...
// @access    Public
exports.forgotPassword = wrap(async (req, res, next) => {
...
// @access    Public
exports.resetPassword = wrap(async (req, res, next) => {
  // Get hashed token
